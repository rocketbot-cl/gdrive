...
3. Setup G-Suite Service Account credentials
Get permissions to handle Google SpreadSheet with Rocketbot

4. List files in Drive
...
14. Delete a file or folder
Delete a file or folder from Drive

15. Share file
Share a file in Drive

16. Manage folder permissions
